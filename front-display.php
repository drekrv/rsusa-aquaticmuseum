...
if ($count == 0) {
    echo '<img src="' . $imageSrc . '" class="resizable-image" style="margin-left: px; margin-right: 12px;" />'; // First image in the row
} elseif ($count < 3) {
    echo '<img src="' . $imageSrc . '" class="resizable-image" style="margin-left: px; margin-right: 12px;" />'; // Images 2 and 3 in the row
} else {
    echo '<img src="' . $imageSrc . '" class="resizable-image" style="margin-left: px; margin-right: 10px; margin-bottom: 40px;" />'; // Images in subsequent rows
}
